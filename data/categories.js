...
const EXAM_UNITS_G6 = [
    ...
    { id: 'u6-special', num: '④', icon: '📝', title: '特殊算・文章題',   sub: '和差算・つるかめ算・過不足算・植木算・年齢算・消去算', difficulty: 4, categories: ['和差算','つるかめ算','過不足算','植木算','年齢算','平均算','消去算','水槽','ニュートン算'], count: 19, available: true  },
